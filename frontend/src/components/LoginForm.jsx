    ...
    <div className='min-h-screen flex flex-col md: flex-row'>
      ...
      <div className='flex-1 flex items-center justify-center p-6 sm:p-12 bg-white'>
        ...
        <form className='space-y-5' onSubmit={handleSubmit}>
          ...
          type='submit'
          disabled={loading}
          className='w-full py-3 bg-linear-to-r from-emerald-700 to-emerald-600 text-white rounded-md text-sm font-semibold hover:from-emerald-800 hover:to-emerald-700 disabled:opacity-50 transition-all duration-200 shadow-lg shadow-emerald-600/30 active:scale-[0.98] flex items-center justify-center'>
